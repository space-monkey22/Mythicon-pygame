...
canvas.pack()
#images
bg_surface=PhotoImage(file=(r"E:\New folder\MYTHICON\mythicon_images\lbinbg.png"))
cloud_surface=PhotoImage(file=(r"E:\New folder\MYTHICON\mythicon_images\hitcloud.png"))
go_surface=PhotoImage(file=(r"E:\New folder\MYTHICON\mythicon_images\hitgo.png"))
black_surface=PhotoImage(file=(r"E:\New folder\MYTHICON\mythicon_images\shadow.png"))
back_surface=PhotoImage(file=(r"E:\New folder\MYTHICON\mythicon_images\back.png"))
